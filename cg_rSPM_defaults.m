...
rspm.estimate.weight  = {fullfile(rSPMdir,'Brainmask-Paxinos-avg176.nii')};
rspm.estimate.template= {fullfile(rSPMdir,'T2-Paxinos-avg176.nii')};
...
%=======================================================================
rspm.hdw.subsamp      = {''};
rspm.hdw.weight       = {fullfile(rSPMdir,'Brainmask-Paxinos-avg176.nii')};
